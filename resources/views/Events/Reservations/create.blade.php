                        ...
                        <form action="{{ route('reservations.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" id="date_reservation" name="date_reservation" class="w-full px-4 py-2 bg-gray-800 text-gray-100 rounded-md" required>
                                </div>
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300 ease-in-out">Create Reservation</button>
                                </div>
                            </div>
                        </form>
                    </div>
